...
<div class="slider">
        <ul class="items">
          <li> <img src="{{ asset('fe/images/img1.jpg') }}" alt="">
            <div class="banner">
          ...
          <div class="line1">
            <div class="line2 wrapper">
              <section class="col1">
                ...
                <div class="pad_bot1">
                  <figure><img src="{{ asset('fe/images/page1_img1.jpg') }}" alt=""></figure>
                </div>
              ...
              <section class="col1 pad_left1">
                ...
                <div class="pad_bot1">
                  <figure><img src="{{ asset('fe/images/page1_img2.jpg') }}" alt=""></figure>
                </div>
              ...
              <section class="col1 pad_left1">
                ...
                <div class="pad_bot1">
                  <figure><img src="{{ asset('fe/images/page1_img3.jpg') }}" alt=""></figure>
                </div>
